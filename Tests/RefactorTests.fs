...
module AttachmentRename =
    ...
    let extensionPreservedWhenUserProvidesStem () =
        ...
        let result = Refactor.rename true folder Seq.empty doc (Position.Mk(0, 2)) "newdiagram"
    ...
    let extensionPreservedWhenUserProvidesFull () =
        ...
        let doc, folder = mkFolderWithAttachment "[[diagram.pdf]]" "diagram.pdf"
        let result = Refactor.rename true folder Seq.empty doc (Position.Mk(0, 2)) "newdiagram.pdf"
    ...
    let multipleReferencesAreAllUpdated () =
        ...
        let result = Refactor.rename true folder Seq.empty doc (Position.Mk(0, 2)) "photo"
    ...
    let skipWhenCursorOutsideLink () =
        ...
        let doc, folder = mkFolderWithAttachment "[[diagram.pdf]]" "diagram.pdf"
        let result = Refactor.rename true folder Seq.empty doc (Position.Mk(0, 0)) "newdiagram"
